...
from stable_baselines import PPO2, A2C, ACER, ACKTR, DQN, HER, DDPG, TRPO, SAC, TD3, DAC, SAIL
...
def create_test_env(env_id, n_envs=1, is_atari=False,
    ...
    if is_atari:
        ...
        #print(env.observation_space, 'atari')
        # Frame-stacking with 4 frames
        env = VecFrameStack(env, n_stack=4)
        #print(env.observation_space, 'VecFrameStack')
    elif n_envs > 1:
