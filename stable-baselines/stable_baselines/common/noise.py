...
class BatchNormalActionNoise(ActionNoise):
    """
    ...
    """
    def __init__(self, mean, sigma, size=None):
        self._mu = mean
        self._sigma = sigma
        self._size=size
    ...
    def __repr__(self):
        return 'NormalActionNoise(mu={}, sigma={}, size={})'.format(self._mu, self._sigma, self._size)
