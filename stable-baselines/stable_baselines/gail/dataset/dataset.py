...
class ExpertDataset(object):
    ...
    def __init__(self, expert_path=None, traj_data=None, train_fraction=0.7, batch_size=64,
        ...
        if 'next_obs' in traj_data.keys():
            ...
            next_observations = np.concatenate([traj_data['obs'][1:traj_limit_idx],traj_data['obs'][traj_limit_idx-1:traj_limit_idx]])
    ...
    def add_absorbing_states(self, data, env):
        ...
        while i < len(states):
            ...
            if dones[i] and current_len < env.max_episode_steps:  # pylint: disable=protected-access
                current_len = 0
